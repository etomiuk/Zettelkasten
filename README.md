...
### December 12
- Delete apprenticeship section (not relevant to topic)
  - but added tiny bit about scaffolding in social
- Delete implicit knowledge section and integrate the paragraphs in culture and experience
- Made connection between culture and implicit knowledge
- Clean up culture and social pages
- Clean up modelling page
...
- Moved some AI stuff to a new page under Tech
### December 6
- Clean up challenges section
  - Moved expertise + creativity link to new page
- Update ML song
### December 4
- Clean up memory and imagery
  - Deleted redundancies with working memory and LTM sections
  - Added musical examples
### December 3
- Clean up emotion part and expanded on the role of emotions in LTM
### December 2
- Clean up composition strategies --> attention section
  - Added the musical examples
- Clean up composition strategies section
  - Elaborated on what creativity really is + examples
  - Cut down redundancies
- Clean up tech section
  - Add example of handwritten vs Musescore scores
### November 30
- Write out the tech section and make connectios to cognitive load
- Delete Connectivism page 
